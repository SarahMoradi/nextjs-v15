      ...
      <section className='px-2 my-40'>
        ...
        <div className='relative pt-0 text-center'>
          ...
          <p className='text-base-content/70  relative z-[2] py-4 m-auto md:text-3xl max-w-5xl font-light !leading-[1.7]'>
            ری‌اکت و نکست‌جی‌اس برترین کتابخونه‌های فرانت‌اند و یکه‌تاز دنیای وب! پیشرفته‌ترین مباحث
            رو اینجا می تونی پیدا کنی. پس همین الان یادگیری رو شروع کن ما هم از ابتدای مسیر با
        ...
        <div className='flex flex-col xl:flex-row gap-4 justify-center xl:justify-between items-center'>
          <div className='text-center xl:text-right'>
            ...
            <p className='mt-3 text-lg'>
              به رایگان، به‌روزترین مقاله‌های دنیای تکنولوژی رو در اختیارت می‌ذاریم؛ چون پیشرفتت
              برامون مهمه!
            </p>
          </div>
